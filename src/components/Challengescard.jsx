...
<div class="grid grid-cols-1 md:grid-cols-3 px-20">
  <div class="p-8">
    <div
    ...
    <a class="text-blue-300 flex items-center hover:text-blue-400" href="/">
      More about us icon
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-5 w-5"
  ...
  <div class="p-8">
    <div
      class="bg-blue-100 rounded-full w-16 h-16 flex justify-center items-center text-blue-500 shadow-2xl"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-8 w-8"
