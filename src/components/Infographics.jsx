            ...
            <div class="">
              <div class="flex flex-col items-center">
                <h2 class="md:mt-5 text-center text-3xl font-medium tracking-tight md:text-4xl">
                  Hire CTO Consulting Services Tailored for <br></br> Startups
                  and Enterprises
                </h2>
                <p class="mt-3 text-xl font-sans text-center text-gray-700 lg:text-neutral-600 md:text-xl">
                  A CTO on Demand offers a transformative way to bring in
                  dynamic technology leaders who can craft strategies, implement
                  technology roadmaps, oversee comprehensive tech innovation,
                  and deliver exceptional technical solutions to achieve
                  business goals.
                </p>
                <div className=" flex justify-center">
                  <img
                    src="/infographics3.png"
