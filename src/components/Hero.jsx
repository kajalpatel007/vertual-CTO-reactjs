      ...
      <div class="relative flex flex-col  max-w-screen-xl px-10 mx-auto md:flex-row mt-20 lg:mt-20 sm:px-6">
        <div class="flex items-center md:pl-24 md:w-1/2 md:pb-20 md:pt-5 md:pr-5">
          <div class="text-left">
            ...
            <p class="max-w-md mx-auto mt-3 text-base text-gray-500 sm:text-lg md:mt-5 md:text-sm lg:text-md md:max-w-3xl">
...
In the era of Gen AI, AI, machine learning, and the Data Science are becoming increasingly crucial for modernization and transformation strategy for businesses, and hence the role of a Chief Technology Officer (CTO) has never been more critical. 
           ...
           <div class="mt-5 sm:flex md:mt-8">
              ...
              <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-0">
                <a
                  href=""
                ...
                ><Link to='https://www.gennextit.com/contact'>Contact us</Link>
                </a>
              </div>
            </div>
        ...
        <div class="md:flex items-center md:w-1/2 md:pb-20 md:pt-5 md:pl-5 hidden">
          <div class="relative w-full p-3 rounded md:pl-10">
            <div class="rounded-lg bg-white  text-black  ">
              <img src='/heroimg.jpeg' className="h-[500px] w-[450px] rounded-lg " />
...
<div class="icon-bar z-50 hidden sm:flex flex-col ">
 
  <Link to="https://twitter.com/gennext_it" class="twitter p-2 pb-2 md:p-3 bg-black"><svg className="w-7 h-7 fill-current " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <Link to="https://www.facebook.com/gennextconsulting" class="facebook p-2 md:p-3 bg-blue-700"><svg className="w-7 h-7 fill-blue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
  ...
  <Link to="https://www.instagram.com/gennext_it/?hl=en" class="instagram  p-2 md:p-3 bg-gradient-to-r from-orange-300 to-pink-600"><svg className="w-7 h-7 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
