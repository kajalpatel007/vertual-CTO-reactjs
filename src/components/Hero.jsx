        ...
        <div class="flex items-center md:pl-24 md:w-1/2 md:pb-20 md:pt-5 md:pr-5">
          <div class="text-left">
            ...
            The Power of a Virtual CTO<br></br> 
              <span class="font-bold text-blue-300">A Game-Changer</span>
...
In the era of Gen AI, AI, machine learning, and the Data Science are becoming increasingly crucial for modernization and transformation strategy for businesses, and hence the role of a Chief Technology Officer (CTO) has never been more critical. 
           ...
           <div class="mt-5 sm:flex md:mt-8">
               <div class="rounded-md shadow">
                <a
                  href=""
                  class="hidden md:flex items-center justify-center w-full px-8 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-blue-300 border border-transparent rounded-md hover:bg-blue-400 focus:outline-none focus:shadow-outline-blue md:py-2 md:text-md md:px-4"
                >
                 Mail us
                </a>
              </div>
              ...
              <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <a
                  href=""
                  class="hidden md:flex items-center justify-center w-full px-8 py-3 text-base font-medium leading-6 text-blue-300 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:text-blue-400 focus:outline-none shadow-lg md:py-2 md:text-md md:px-4"
      ...
      <img
          ...
          className="w-[45px] md:w-[55px] animate-bounce focus:animate-none hover:animate-none shadow-xl rounded-full fixed bottom-7 right-7 "
        ></img></a>
    </div>
  );
};
