...
const Hero = () => {
  return (
    <div>
      <div class="relative flex flex-col items-center justify-center max-w-screen-xl px-10 mx-auto md:flex-row mt-20 lg:mt-28 sm:px-6">
        ...
        <div class="md:flex items-center md:w-1/2 md:pb-20 md:pt-5 md:pl-5 hidden">
          <div class="relative w-full p-3 rounded md:pl-10">
            <div class="rounded-lg bg-white  text-black  ">
              <img src='/public/heroimg.jpeg' className="h-[500px] w-[450px] rounded-full " />
              {/* <img src='/public/heroimg.jpeg' className="h-[300px] flex w-[200px] -top-[60%] " /> */}
            </div>
          </div>
        </div>
      </div>
...
<div class="icon-bar z-50 ">
  ...
  <a href="https://www.instagram.com/gennext_it/?hl=en" class="instagram  p-2 md:p-3 bg-gradient-to-r from-orange-300 to-red-400"><svg className="w-7 h-7 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
